...
class JDXTabbarController: UITabBarController {
...
//        TabBarLine.backgroundImage = UIImage.qmui_image(with: UIColor.white, size: CGSize.init(width: kScreen_Width, height: 50), cornerRadius: 0)
    ...
    private func createSubViewControllers(){
        ...
        let homePage = UINavigationController.init(rootViewController: JDXHomeViewController.init(collectionViewLayout: layout))
        ...
        let categoryPage = UINavigationController.init(rootViewController: JDXCategoryViewController())
        ...
        let messagePage = UINavigationController.init(rootViewController: JDXMessageViewController())
        ...
        let shopPage = UINavigationController.init(rootViewController: JDXShopViewController())
        ...
        let mePage = UINavigationController.init(rootViewController: JDXProfileViewController())
